...
export function renderHeader(t: Translations, locale: Locale): string {
  return `
    <div class="container nav">
      <a href="#" class="brand">
        <img src="/logo/logo-micro-dark-v2.svg" alt="${t.header.brand}" height="32" class="logo-dark" />
      </a>
      <nav class="menu">
        ...
        <label style="display:inline-flex;align-items:center;gap:8px">
          ...
          <select id="lang-switch" style="padding:8px;border-radius:8px;border:1px solid rgba(255,255,255,.2);background:rgba(255,255,255,.1);color:var(--white);cursor:pointer">
